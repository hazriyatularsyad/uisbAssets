          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-zinc-300 px-3 py-2 text-white outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-5 w-full bg-white px-4 py-2.5 font-semibold text-black transition hover:bg-zinc-300 cursor-pointer"
            >
